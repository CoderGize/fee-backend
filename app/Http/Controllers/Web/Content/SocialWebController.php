...
class SocialWebController extends Controller
{
    public function show_social()
    {
        ...
        return view('admin.web.social.show_social', compact(
            'social'
        ));
    }
    ...
    public function update_social($id)
    {
        ...
        return view('admin.web.social.update_social', compact(
            'social'
        ));
    }
    ...
    public function update_social_confirm(Request $request)
    {
        ...
        return redirect('/admin/web/show_social')->with('message','Socials Updated');
