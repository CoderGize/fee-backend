                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header pb-0">
                            <h6>Carousel Section</h6>
                        </div>

                        <div class="row mb-3">
                            <div class="col-12 d-flex justify-content-center">
                                <form action="/admin/web/carousel_show" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-check form-switch">
                                        <input
                                            class="form-check-input {{ $show->carousel_sh == 1 ? 'bg-success' : 'bg-danger' }}"
                                            type="checkbox" role="switch" id="flexSwitchCheckDefault"
                                            onchange="this.form.submit()" value="{{ $show->carousel_sh == 1 ? '0' : '1' }}"
                                            name="datash" {{ $show->carousel_sh == 1 ? 'checked' : '' }}>
                            ...
                            <div class="col-12">
                                <div class="d-flex justify-content-center">
                                    ...
                                    @include('admin.web.carousel.add_carousel')
                        ...
                        <div class="card-body px-0 pt-0 mt-4 pb-2">
                            ...
                            <div class="table-responsive p-0">
                                ...
                                {{ $carousel->render('admin.web.pagination') }}
                            </div>
                        </div>
