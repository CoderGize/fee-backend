                    ...
                    <div class="card mb-4">
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                <div class="d-flex justify-content-center">
                                    ...
                                    @include('admin.web.subscriber.export_designletter')
                        ...
                        <div class="card-body px-0 pt-0 mt-4 pb-2">
                            ...
                            <div class="table-responsive p-0">
                                        ...
                                        @forelse ($designletter as $data)
                                            <tr class="text-center">
                                                ...
                                                <td class="align-middle">
                                                    <a href="{{ url('admin/web/delete_newsletter', $data->id) }}"
                                ...
                                {{ $designletter->render('admin.web.pagination') }}
                            </div>
                        </div>
